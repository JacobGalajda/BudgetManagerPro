    ...
    value: function chartPivot(pivotConfig) {
      ...
      return this.pivot(pivotConfig).map(function (_ref22) {
        ...
        return _objectSpread({
          ...
          return _defineProperty__default['default']({}, _this3.axisValuesString(yValues, ','), m && validate(m));
        }).reduce(function (a, b) {
    ...
    value: function tableColumns(pivotConfig) {
      ...
      var toColumns = function toColumns() {
        ...
        return Object.values(item).map(function (_ref32) {
          var key = _ref32.key,
              currentItem = _objectWithoutProperties__default['default'](_ref32, ["key"]);
      ...
      return seriesNames.map(function (axisValues) {
        return {
          title: _this4.axisValuesString(pivotConfig.y.find(function (d) {
            return d === 'measures';
          }) ? ramda.dropLast(1, axisValues).concat(measures[ResultSet.measureFromAxis(axisValues)].title) : axisValues, ', '),
