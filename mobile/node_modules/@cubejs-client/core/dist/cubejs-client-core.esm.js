...
import { pipe, map, filter, reduce, minBy, maxBy, unnest, groupBy, fromPairs, pluck, mergeDeepLeft, mergeAll, uniq, dropLast, clone, equals } from 'ramda';
      ...
      return seriesNames.map(function (axisValues) {
        return {
          title: _this4.axisValuesString(pivotConfig.y.find(function (d) {
            return d === 'measures';
          }) ? dropLast(1, axisValues).concat(measures[ResultSet.measureFromAxis(axisValues)].title) : axisValues, ', '),
...
export { HttpTransport, ResultSet, defaultHeuristics, defaultOrder, isQueryPresent, moveItemInArray, movePivotItem };
