(function (global, factory) {
	...
	*/
	...
	var FORCED$2 = NEGATIVE_ZERO || !STRICT_METHOD$1 || !USES_TO_LENGTH$4;
	...
	function _isPlaceholder(a) {
	  return a != null && _typeof_1(a) === 'object' && a['@@functional/placeholder'] === true;
	}
	...
	if (FORCED$8) {
	  ...
	  var proxy = function (key) {
	    key in RegExpWrapper || defineProperty$b(RegExpWrapper, key, {
	      configurable: true,
	...
	var FORCED$9 = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || !STRICT_METHOD$5;
	...
	function _equals(a, b, stackA, stackB) {
	  ...
	  switch (typeA) {
	    ...
	    case 'Number':
	    case 'String':
	      if (!(_typeof_1(a) === _typeof_1(b) && _objectIs$1(a.valueOf(), b.valueOf()))) {
	        return false;
	      }
	...
	_export({ target: 'Date', proto: true, forced: FORCED$b }, {
	  // eslint-disable-next-line no-unused-vars
	...
	var moment = createCommonjsModule(function (module, exports) {
	  ...
	  (function (global, factory) {
	    ...
	    function humanize(argWithSuffix, argThresholds) {
	      ...
	      if (_typeof_1(argWithSuffix) === 'object') {
	      ...
	      if (_typeof_1(argThresholds) === 'object') {
	    ...
	    return function (t) {
	      ...
	      var s = function () {
	        ...
	        return function (e, n) {
	          ...
	          c = "function" == typeof Symbol && "symbol" == _typeof_1(Symbol.iterator) ? function (t) {
	        return _typeof_1(t);
	      } : function (t) {
	        return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof_1(t);
	      },
	          f = function () {
	        function t(t, e) {
	      ...
	      t.exports = function () {
	        ...
	        return !!r[_typeof_1(Symbol.iterator)] && !!r[_typeof_1(Symbol.toPrimitive)] && !!r[_typeof_1(Symbol.toStringTag)];
	      };
	    }, function (t, e, n) {

	      t.exports = function (t) {
	        return !!t && ("symbol" == _typeof_1(t) || !!t.constructor && "Symbol" === t.constructor.name && "Symbol" === t[t.constructor.toStringTag]);
	      };
	    }, function (t, e, n) {
	      ...
	      _i = function i(t) {
	        ...
	        var t = s(this);
	        return "symbol" == _typeof_1(t) ? t : t.toString();
	...
	var ResultSet = /*#__PURE__*/function () {
	  ...
	  createClass(ResultSet, [{
	    ...
	    value: function chartPivot(pivotConfig) {
	      ...
	      return this.pivot(pivotConfig).map(function (_ref22) {
	        ...
	        return _objectSpread({
	          ...
	          xValues: xValues
	        }, yValuesArray.map(function (_ref23) {
	          var _ref24 = slicedToArray(_ref23, 2),
	              yValues = _ref24[0],
	              m = _ref24[1];

	          return defineProperty$5({}, _this3.axisValuesString(yValues, ','), m && validate(m));
	        }).reduce(function (a, b) {
	    ...
	    value: function tablePivot(pivotConfig) {
	      ...
	      return this.pivot(normalizedPivotConfig).map(function (_ref26) {
	        var xValues = _ref26.xValues,
	            yValuesArray = _ref26.yValuesArray;
	        return fromPairs(normalizedPivotConfig.x.map(function (key, index) {
	          return [key, xValues[index]];
	        }).concat(isMeasuresPresent ? yValuesArray.map(function (_ref27) {
	    ...
	    value: function tableColumns(pivotConfig) {
	      ...
	      var extractFields = function extractFields(key) {
	        var _ref29 = flatMeta[key] || {},
	            title = _ref29.title,
	            shortTitle = _ref29.shortTitle,
	            type = _ref29.type,
	      ...
	      var toColumns = function toColumns() {
	        ...
	        return Object.values(item).map(function (_ref32) {
	          var key = _ref32.key,
	              currentItem = objectWithoutProperties(_ref32, ["key"]);
	    ...
	    value: function seriesNames(pivotConfig) {
	      ...
	      return seriesNames.map(function (axisValues) {
	        return {
	          title: _this4.axisValuesString(pivotConfig.y.find(function (d) {
	            return d === 'measures';
	          }) ? dropLast$1(1, axisValues).concat(measures[ResultSet.measureFromAxis(axisValues)].title) : axisValues, ', '),
	  ...
	  createClass(HttpTransport, [{
	    ...
	    value: function request(method, _ref2) {
	      ...
	      var searchParams = new URLSearchParams(params && Object.keys(params).map(function (k) {
	        return defineProperty$5({}, k, _typeof_1(params[k]) === 'object' ? JSON.stringify(params[k]) : params[k]);
	      }).reduce(function (a, b) {
	...
	var USES_TO_LENGTH$b = arrayMethodUsesToLength('every');
	...
	function _objectSpread$2(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$3(Object(source), true).forEach(function (key) { defineProperty$5(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$3(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
	...
	function defaultOrder(query) {
	  ...
	  if (granularity) {
	    return defineProperty$5({}, granularity.dimension, 'asc');
	  } else if ((query.measures || []).length > 0 && (query.dimensions || []).length > 0) {
	    return defineProperty$5({}, query.measures[0], 'desc');
	  } else if ((query.dimensions || []).length > 0) {
	    return defineProperty$5({}, query.dimensions[0], 'asc');
	  }
	...
	function _objectSpread$3(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$4(Object(source), true).forEach(function (key) { defineProperty$5(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$4(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
